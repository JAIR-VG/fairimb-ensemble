...
for element in fname:
    ...
    for folds in range(1,(nfolds+1)):
        ...
        ftst = 'datasets/'+element+'/'+element+'-5x2-'+str(folds)+'tst.prn'
        ftra = 'datasets/'+element+'/'+element+'-5x2-'+str(folds)+'tra.prn'
   ...
   # print(rmat)
    ...
    ficherotxt = 'datasets/5x2/'+element+'-'+str(nfolds)+'5x2-'+str(k_neighbors)+'nn.avg.txt'
