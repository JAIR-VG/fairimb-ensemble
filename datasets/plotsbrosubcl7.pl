...
plot '03subcl5-800-7-70-bi-SP.txt' u 1:2 w p ls 3 title 'S',\
'03subcl5-800-7-70-bi-BP.txt' u 1:2 w p ls 4 title 'B',\
'03subcl5-800-7-70-bi-RP.txt' u 1:2 w p ls 5 title 'R',\
'03subcl5-800-7-70-bi-OP.txt' u 1:2 w p ls 1 title 'O',\
'03subcl5-800-7-70-bi-N.txt' u 1:2 w p ls 2 title 'N'
